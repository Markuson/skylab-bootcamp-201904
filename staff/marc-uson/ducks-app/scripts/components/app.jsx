...
class App extends Component {
    ...
    render() {
        ...
        return <>
            ...
            {visible === 'register' && <Register lang={lang} onRegister={handleRegister} onLogin={handleLoginNavigation} error={error} />}

            {visible === 'register-ok' && <RegisterOk lang={lang} onLogin={handleLoginNavigation} />}

            {visible === 'login' && <Login lang={lang} onLogin={handleLogin} onRegister={handleRegisterNavigation} error={error} />}
